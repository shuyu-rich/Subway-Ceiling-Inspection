    ...
    def process_common_model(self, color_frame):
        ...
        for i in range(60):
            for j in range(60):
                ...
                x, y, v_d = point_xyz_data[int(1332 - i)][int(1024 - j)]
                if v_d > 50:
                    v_bot_list.append(v_d)
                x, y, v_r = point_xyz_data[int(768 - i)][int(1900 - j)]
                if v_r > 50:
        ...
        if len(v_bot_list) < 1:
            for i in range(1, 2048):
                x, y, v_t = point_xyz_data[int(1332)][int(i)]
                if v_t > 50:
                    v_top_list.append(v_t)
        if len(v_rig_list) < 1:
            for i in range(1, 1536):
                x, y, v_r = point_xyz_data[int(i)][int(1900)]
                if v_r > 50:
                    v_rig_list.append(v_r)
