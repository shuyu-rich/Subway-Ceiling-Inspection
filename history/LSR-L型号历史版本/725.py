...
class ZoomWindow(QDialog):
    ...
    def save_image(self):
        ...
        # 如果 damage_type_data 是列表，将其转换为字符串
        if isinstance(damage_type_data, list):
            damage_type_data_str = ','.join(map(str, damage_type_data))
        else:
            damage_type_data_str = str(damage_type_data)
        new_data_entry = {
            ...
            "damageDesc": "墙面有裂缝",
            "damageType": damage_type_data_str,
