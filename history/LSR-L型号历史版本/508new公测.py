...
class ImageCaptureThread(QThread):
    ...
    def load_model(self, model_name):
        ...
        weight_paths = {
            '铝板': 'D:\\PythonCode\\yolov5\\runs\\train\\all\\506fanglvban.pt',
            '冲孔板': 'D:\PythonCode\yolov5/runs/train/chongkong/weights/best.pt',
            '拉网': 'D:\PythonCode\yolov5/runs/train/all/506heibai.pt',
            '铝条板': 'D:\PythonCode\yolov5/runs/train/all/ltb.pt',
            '栅格加网': 'D:\PythonCode\yolov5/runs/train/all/shangejiawang.pt',
            '矿棉板': 'D:\PythonCode\yolov5/runs/train/all/kuangmian.pt',
            '栅格': 'D:\PythonCode\yolov5/runs/train/all/shange.pt',
            '铝方通': 'D:\PythonCode\yolov5/runs/train/all/shange.pt',
    ...
    def capture_images(self):
        ...
        if self.selected_model in self.processing_functions:
            ...
            detection_results, tankuang = self.processing_functions[self.selected_model](color_image)
    ...
    def process_aluminum_square_tube(self, color_frame):
        ...
        results = model(color_frame)
        # 处理检测结果
        huakuang = self.process_detections(results, color_frame)
        # 更新UI显示
        # self.display_image(color_frame)
        detection_img = QImage(color_frame.data, image_width, image_height, QImage.Format_RGB888)
        return detection_img, huakuang
        ...
        for cuofengg_box in cuofengg_boxes:
            ...
            for i in range(len(inside_cuofeng_boxes) - 1):
                ...
                if is_horizontal:
                    ...
                    if float(vertical_list2) >= 10 or float(depth_difference) >= 3.0:
                        huakuang = True
                        self.alarmStatusChanged.emit(True)
...
class MyWindow(QMainWindow):
    ...
    def setupTab1(self):
        ...
        self.checkbox.setFont(font)  # 设置下拉框的字体
        ...
        self.checkbox_1.setFont(font)  # 设置下拉框的字体
        ...
        self.checkbox_2.setFont(font)  # 设置下拉框的字体
        ...
        self.checkbox_3.setFont(font)  # 设置下拉框的字体
        ...
        self.checkbox_4.setFont(font)  # 设置下拉框的字体
        ...
        self.checkbox_5.setFont(font)  # 设置下拉框的字体
    ...
    def setupTab2(self):
        ...
        self.db_connection = sqlite3.connect("D:/PythonCode/sql/text.db")
    ...
    def analysis_completed(self):
        ...
        if selected_ceiling_type == "铝板":
            model_path = 'C:/Users/20115/Desktop/yolov5'  # yolov5根目录
            # weight_path = 'C:/Users/20115/Desktop/yolov5/runs/train/exp4/weights/best.pt'  # 权重路径
            weight_path = 'C:/Users/20115/Desktop/yolov5/runs/train/all/111.pt'
