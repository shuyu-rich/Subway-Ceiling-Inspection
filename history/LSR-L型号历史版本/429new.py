...
class ImageCaptureThread(QThread):
    ...
    def detect_objects(self, color_frame):
        ...
        if self.selected_model == "铝板":
            ...
            model_path = './yolov5'
            weight_path = 'D:\\PythonCode\\yolov5\\runs\\train\\all\\flvban.pt'
            ...
            weight_path = 'C:/Users/20115/Desktop/yolov5/runs/train/all/kuangmian.pt'
            # weight_path = 'C:/Users/20115/Desktop/yolov5/runs/train/all/heibai.pt'
...
class MyWindow(QMainWindow):
    ...
    def setupTab2(self):
        ...
        self.line_combo.setFixedSize(100, 20)  # 设置固定大小为宽度 100，高度 30
        self.station_combo.setFixedSize(100, 20)
        self.area_combo.setFixedSize(100, 20)
        ...
        self.area_combo2.setFixedSize(100, 20)  # 设置固定大小为宽度 100，高度 30
        self.area_combo1.setFixedSize(100, 20)
        self.area_combo3.setFixedSize(100, 20)
        ...
        self.model_combo.setFixedSize(100, 20)
        ...
        self.capture_interval_combo.setFixedSize(100, 20)
        ...
        self.capture_interval_label1.setFixedSize(100, 30)
        self.exposure_combo = QComboBox()
        exposure_options = ["40","60","80", "100", "120", "140","160"]  # 曝光度选项
        self.exposure_combo.setFixedSize(100,20)
