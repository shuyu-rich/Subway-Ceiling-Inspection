...
class ImageCaptureThread(QThread):
    ...
    def capture_images(self):
        ...
        self.depth_img = QImage(depth_colormap.data, depth_colormap.shape[1], depth_colormap.shape[0], QImage.Format_RGB888)
...
class MyWindow(QMainWindow):
    ...
    def pack_1(self):
        ...
        # 根据当前日期设置要打包的文件夹路径
        folder_path = f'D:/PythonCode/{today}'

        # 根据当前日期设置压缩文件的输出路径和名称
        zip_path = f'D:/PythonCode/{today}.zip'
    ...
    def update_data(self):
        ...
        self.db_cursor.execute("SELECT create_time FROM facilities WHERE line_name=? AND station_name=?",
    ...
    def start_timer(self):
        ...
        self.capture_thread.set_capture_interval(self.selected_interval if hasattr(self,'selected_interval') else 10000)  # 将采集时间间隔设置到图像采集线程中，默认值为10000毫秒（10秒）
